...
libraryDependencies ++= Seq(
  "com.ubirch.avatar" %% "client" % "0.3.10"
)
```
...
libraryDependencies ++= Seq(
  "com.ubirch.avatar" %% "cmdtools" % "0.3.10"
)
```
...
libraryDependencies ++= Seq(
  "com.ubirch.avatar" %% "config" % "0.3.10"
)
```
...
libraryDependencies ++= Seq(
  "com.ubirch.avatar" %% "model" % "0.3.10"
)
```
...
libraryDependencies ++= Seq(
  "com.ubirch.avatar" %% "server" % "0.3.10"
)
```
...
libraryDependencies ++= Seq(
  "com.ubirch.avatar" %% "test-base" % "0.3.10"
)
```
