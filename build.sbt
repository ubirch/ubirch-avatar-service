...
lazy val ubirchOidcUtils = ubirchUtilG %% "oidc-utils" % "0.4.5-SNAPSHOT" excludeAll (excludedLoggers: _*)
...
lazy val ubirchUserClientRest = "com.ubirch.user" %% "client-rest" % "0.4.8-SNAPSHOT" excludeAll (excludedLoggers: _*)
