...
lazy val ubirchUserClientRest = "com.ubirch.user" %% "client-rest" % "0.4.18-SNAPSHOT" excludeAll (excludedLoggers: _*)
lazy val ubirchKeyClientRest = "com.ubirch.key" %% "client-rest" % "0.1.12-SNAPSHOT" excludeAll (excludedLoggers: _*)
