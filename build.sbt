...
val ubirchElasticsearchClientBinary = ubirchUtilG %% "elasticsearch-client-binary" % "3.3.1" excludeAll (excludedLoggers: _*)
...
val ubirchOidcUtils = ubirchUtilG %% "oidc-utils" % "0.8.10-SNAPSHOT" excludeAll (excludedLoggers: _*)
