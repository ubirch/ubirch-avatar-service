...
lazy val ubirchElasticsearchClientBinary = ubirchUtilG %% "elasticsearch-client-binary" % "2.0.1" excludeAll (excludedLoggers: _*)
...
lazy val ubirchOidcUtils = ubirchUtilG %% "oidc-utils" % "0.3.0" excludeAll (excludedLoggers: _*)
