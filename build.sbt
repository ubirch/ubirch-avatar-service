...
lazy val ubirchElasticsearchClientBinary = ubirchUtilG %% "elasticsearch-client-binary" % "2.3.3" excludeAll (excludedLoggers: _*)
...
lazy val ubirchOidcUtils = ubirchUtilG %% "oidc-utils" % "0.4.14" excludeAll (excludedLoggers: _*)
...
lazy val ubirchUserClientRest = "com.ubirch.user" %% "client-rest" % "0.6.3" excludeAll (excludedLoggers: _*)
lazy val ubirchKeyClientRest = "com.ubirch.key" %% "client-rest" % "0.2.1" excludeAll (excludedLoggers: _*)
