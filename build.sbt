...
lazy val ubirchOidcUtils = ubirchUtilG %% "oidc-utils" % "0.4.15" excludeAll (excludedLoggers: _*)
...
lazy val ubirchKeyClientRest = "com.ubirch.key" %% "client-rest" % "0.2.2" excludeAll (excludedLoggers: _*)
