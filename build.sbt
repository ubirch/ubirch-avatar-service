...
lazy val ubirchCrypto = ubirchUtilG %% "crypto" % "0.4.4" excludeAll (excludedLoggers: _*)
...
lazy val ubirchUserClientRest = "com.ubirch.user" %% "client-rest" % "0.8.3" excludeAll (excludedLoggers: _*)
