...
lazy val ubirchOidcUtils = ubirchUtilG %% "oidc-utils" % "0.7.3.2" excludeAll (excludedLoggers: _*)
...
lazy val ubirchUserClientRest = "com.ubirch.user" %% "client-rest" % "0.11.0" excludeAll (excludedLoggers: _*)
