...
lazy val ubirchOidcUtils = ubirchUtilG %% "oidc-utils" % "0.4.9" excludeAll (excludedLoggers: _*)
...
lazy val ubirchUserClientRest = "com.ubirch.user" %% "client-rest" % "0.5.0" excludeAll (excludedLoggers: _*)
