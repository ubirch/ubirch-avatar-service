...
lazy val ubirchMongo = ubirchUtilG %% "mongo-utils" % "0.3.3-SNAPSHOT" excludeAll (excludedLoggers: _*)
...
lazy val ubirchUserClientRest = "com.ubirch.user" %% "client-rest" % "0.4.13" excludeAll (excludedLoggers: _*)
