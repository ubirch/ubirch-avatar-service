...
lazy val ubirchOidcUtils = ubirchUtilG %% "oidc-utils" % "0.7.0" excludeAll (excludedLoggers: _*)
...
lazy val ubirchUserClientRest = "com.ubirch.user" %% "client-rest" % "0.10.1" excludeAll (excludedLoggers: _*)
